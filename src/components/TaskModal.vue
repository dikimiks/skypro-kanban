<template>
  <div class="pop-browse" id="popBrowse" style="display: none;">
    <div class="pop-browse__container">
      <div class="pop-browse__block">
        <div class="pop-browse__content">
          <div class="pop-browse__top-block">
            <h3 class="pop-browse__ttl">{{ taskTitle }}</h3>
            <div :class="['categories__theme theme-top', `_${theme}`, '_active-category']">
          ...
          <div class="pop-browse__wrap">
            <form class="pop-browse__form form-browse" action="#">
              ...
              <div class="calendar__block">
                ...
                <div class="calendar__period">
                  <p class="calendar__p date-end">
                    Срок исполнения:
                    <span class="date-control">{{ date || 'Не указана' }}</span>
                  </p>
                </div>
              </div>
            </div>
          ...
          <div class="theme-down__categories theme-down">
            ...
            <div :class="['categories__theme', `_${theme}`, '_active-category']">
              <p :class="`_${theme}`">{{ themeText }}</p>
            </div>
          </div>
          ...
          <div class="pop-browse__btn-browse">
            ...
            <button class="btn-browse__close _btn-bg _hover01" onclick="document.getElementById('popBrowse').style.display='none'">
              Закрыть
            </button>
          </div>
        </div>
